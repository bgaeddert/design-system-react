  ...
  _createClass(Datepicker, [{
    ...
    value: function render() {
      ...
      var clonedInputProps = {
        ...
        iconRight: this.props.children && !!this.props.children.props.iconRight || _react2.default.createElement(_inputIcon2.default // Remove || for assistiveText at next breaking change
        , {
          assistiveText: {
            icon: this.props.assistiveTextOpenCalendar || assistiveText.openCalendar // eslint-disable-line react/prop-types
      ...
      var clonedInput = this.props.children ? _react2.default.cloneElement(this.props.children, _objectSpread({}, clonedInputProps)) : _react2.default.createElement(_input2.default, clonedInputProps);
